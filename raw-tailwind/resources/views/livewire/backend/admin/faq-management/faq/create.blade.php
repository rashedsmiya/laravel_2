    ...
    <div class="glass-card rounded-2xl p-6 mb-6">
        ...
        <form wire:submit="save">
            <div class="mt-6 space-y-4 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <x-ui.label for="question" :value="__('Question')" required />
                    <x-ui.input id="question" type="text" class="mt-1 block w-full" wire:model="form.question"
                        placeholder="Question" />
                    <x-ui.input-error :messages="$errors->get('form.question')" class="mt-2" />
                </div>

                <div>
                    <x-ui.label for="answer" :value="__('Answer')" required />
                    <x-ui.input id="answer" type="text" class="mt-1 block w-full" wire:model="form.answer"
                        placeholder="Answer" />
                    <x-ui.input-error :messages="$errors->get('form.answer')" class="mt-2" />
                </div>
