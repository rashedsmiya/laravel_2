<section>
    ...
    <div class="glass-card rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('Seller Trash List') }}</h2>
    ...
    <x-ui.confirmation-modal :show="'showDeleteModal'" :title="'Delete this Seller?'" :message="'Are you absolutely sure you want to remove this seller? All associated data will be permanently deleted.'" :method="'forceDelete'"
