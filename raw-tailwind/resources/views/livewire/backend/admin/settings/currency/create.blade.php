        ...
        <div class="glass-card rounded-2xl p-6 mb-6">
            <div class="flex items-start gap-3">
                <div class="flex-shrink-0 mt-1">
                    <div class="flex items-center justify-center w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-900/30">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-3 p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900/20 border border-zinc-200 dark:border-zinc-800">
        ...
        <form wire:submit="save">
                ...
                <div>
                    ...
                    @if($defaultCurrency)
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            {{ __('Relative to') }} {{ $defaultCurrency->code }} ({{ $defaultCurrency->symbol }})
                        </p>
                    @endif
                </div>
            </div>
            <div class="mt-6 space-y-4 grid grid-cols-2 gap-5">
                ...
                {{-- <div class="form-control w-full">
                    ...
                    @if(!$defaultCurrency)
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            {{ __('Recommended to set as default for the first currency') }}
                        </p>
                    @endif
                </div> --}}
            </div>
